...
<%@ page import="fr.iut2.Jeu1.JeuFactory" %>
...
<%
    ...
    String mainJoueur = request.getParameter("mainJoueur");

    // Classe jeu.JeuFactory importée par la directive "page import="fr.iut2.tc4.jeu1.jeu.JeuFactory"
    String mainOrdinateur = JeuFactory.randomMain();
%>

<%-- Element de script : Expression --%>
Joueur <img src="ressources/<%= mainJoueur %>.jpg"/>
vs Ordinateur <img src="ressources/<%= mainOrdinateur %>.jpg"/>
